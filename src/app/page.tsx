    ...
    <div className="font-base">
      ...
      <div className="mt-8 text-base">
        ...
        <p>
          ...
          potential to replace all other social media platforms". I had to learn
          JavaScript first. And that thing was complete chaos. But I survived.
          Thanks to the new hot topic called React. I started playing with React
          because there were tons of cool libraries around it, and it was easy
          to add. I had already watched some videos on it anyway. Back then, I
          used bootstrap, but material ui always intrigued me. It had that fancy
          ripple effect on buttons. Most probably, I learned react just to use
          material.
        </p>
        <br />
        <p>
